 ...
 * <p>
 * The adjacency matrix is a square matrix that represents a directed graph. The entry at index (i, j) is {@code 1}, iff
...
public class AdjacencyMatrix implements AdjacencyRepresentation {
    ...
    public boolean hasEdge(int from, int to) {
        return crash(); //TODO: H2 a) - remove if implemented
    }
